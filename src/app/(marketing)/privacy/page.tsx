    ...
    <LegalArticle title="Privacy policy">
      ...
      <section id="what-we-collect">
        ...
        <ul>
          ...
          <li>
            <strong>Payment data:</strong> Stripe customer/subscription
            references and product identifiers. We do not receive or store your
            full card details — Stripe processes card data.
          </li>
          <li>
      ...
      <section id="how-we-use">
        ...
        <ul>
          ...
          <li>Processing upgrades via Stripe.</li>
          <li>
